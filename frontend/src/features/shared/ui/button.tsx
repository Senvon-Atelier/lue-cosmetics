...
export function Button({
  ...
  const baseStyles = 'btn inline-flex items-center justify-center gap-2 font-label font-medium transition-all duration-[var(--dur)] ease-[var(--ease)] focus:outline-none focus:ring-2 focus:ring-lavender-400 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-px';
